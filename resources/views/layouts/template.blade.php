            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.rekapan') }}" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Rekapan Presensi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.aprovalizin')}}" class="nav-link">
                                <i class="nav-icon bi bi-palette"></i>
                                <p>Aproval Izin</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.jamkerja') }}" class="nav-link">
                                        <i class="nav-icon bi bi-box-arrow-in-right"></i>
                                        <p>
                                            Jam Kerja
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.lokasiabsensi') }}" class="nav-link">
                                        <i class="nav-icon bi bi-box-arrow-in-right"></i>
                                        <p>
                                            Lokasi
